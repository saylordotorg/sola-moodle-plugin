...
$string['settings:avatar_saylor'] = 'Лого на Saylor Academy (по подразбиране)';
...
$string['chat:greeting'] = 'Здравейте! Аз съм вашият AI тутор за този курс. Как мога да ви помогна днес?';
...
$string['chat:expand'] = 'Разширяване на чата';
$string['chat:collapse'] = 'Свиване на чата';
...
$string['chat:greeting'] = 'Здравейте, {$a}! Аз съм SOLA, вашият онлайн асистент за обучение от Saylor.';
...
$string['chat:starter_quiz'] = 'Тествайте ме';
...
$string['chat:starter_ell_practice'] = 'Практикуване на говорене';
